...
export const SEEDED_ACCOUNTS = [
  { role_label: 'Platform Administrator', email: 'admin.sharma@legadoc.gov.in', designation: 'Director (Information Systems)' },
  { role_label: 'Investigating Officer (IO)', email: 'officer.rao@police.gov.in', designation: 'Inspector of Police (Cyber Cell)' },
  { role_label: 'Duty Officer (Station Intake)', email: 'duty.verma@police.gov.in', designation: 'Duty Officer (Station Intake)' },
  { role_label: 'Station House Officer (SHO)', email: 'sho.singh@police.gov.in', designation: 'Station House Officer' },
  { role_label: 'Judicial Bench (Magistrate)', email: 'magistrate.iyer@court.gov.in', designation: 'Chief Judicial Magistrate' },
  { role_label: 'Public Prosecutor', email: 'prosecutor.sen@court.gov.in', designation: 'Senior Public Prosecutor' },
