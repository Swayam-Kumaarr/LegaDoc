  ...
  const metrics = [
    {
      ...
      sub: "Visible under your current role",
    },
    {
      label: "FIR Registered",
      value: String(
        cases.filter((c) => c.investigation_status === "FIR_Registered").length,
      ),
      sub: "Awaiting evidence collection",
    },
    {
      label: "Charge Sheet Filed",
      value: String(
        cases.filter((c) => c.investigation_status === "Charge_Sheet_Filed")
          .length,
      ),
      sub: "Section 173 CrPC / BNSS 2023",
    },
    {
      label: "In Trial or Judgment",
      value: String(
        cases.filter((c) =>
          ["Trial", "Judgment"].includes(c.investigation_status),
        ).length,
      ),
      sub: "Before the court",
    },
  ];
        ...
        <div className="page-header">
          <div>
            ...
            <p className="page-desc">
              Case dockets visible to this official identity, pulled live from
              the case registry.
            </p>
          </div>
          ...
          >
            <div>
              ...
              <span className="text-caption">
                Case dockets visible to this official identity under Section
                156/157 CrPC
              </span>
            </div>
            <Link
              ...
              <tbody>
                {error ? (
                  ...
                  <tr>
                    ...
                    >
                      No cases yet. Register the first FIR to get started.
                    </td>
                  </tr>
                ) : (
                  cases.map((c) => (
                    <tr key={c.id}>
                      ...
                      <td>
                        <StatusChip
                          ...
                          label={c.investigation_status.replace(/_/g, " ")}
                        />
                      </td>
