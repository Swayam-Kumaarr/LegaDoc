...
export default function ForcedPasswordChange() {
  ...
  return (
    ...
    >
      <div
        className="card"
        style={{ maxWidth: "440px", width: "100%", padding: "28px" }}
      >
        ...
        >
          {user?.name ? `${user.name}, your` : "Your"} account was just
          provisioned with a temporary password. You must set your own before
          continuing.
        </p>
